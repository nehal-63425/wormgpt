...
if not BOT_TOKEN:
    raise ValueError("7850860494:AAG3JjXQMRalenAaQ5ZSh_oWhL6vuUpv2tA")

ADMIN_CHAT_ID = int(os.getenv("ADMIN_CHAT_ID", "7528904760"))
...
# Developer info
DEVELOPER_USERNAME = "@normswift"

# Welcome message
WELCOME_MESSAGE = "🎉 *Welcome to WORM AI* 🎉\n\nYour advanced AI assistant is ready to help you\\!"
